...
namespace ClassStack
{
    class Program
    {
        ...
        public static void StackTask14()
        {
        ...
        public static void StackTask8()
        {
            ...
            Console.WriteLine(c);
            Console.WriteLine("M - minimum, m - maximum");
        ...
        public static void StackTask10()
        {
            /*10.	В текстовом файле записана без ошибок формула вида:
        ...
        public static void QueueTask8()
        {
            ...
            Queue<Staff> queue = new Queue<Staff>();
            // одним циклом никак
            for (int i = 0; i < 20; i++)
            {
                queue.Enqueue(new Staff("XJ" + rand.Next(1, 100), true, rand.Next(18, 120), rand.Next(100, 1000000)));
            }
            Console.WriteLine("\n------------------------------------------Младше 30 лет\n");
            foreach (Staff item in queue)
            {
                if (item.age < 30)
                    Console.WriteLine("Full name: " + item.fullName + " | Male: " + item.gender + " | Age: " + item.age + " | Salary size: " + item.salarySize);
            }
            Console.WriteLine("\n------------------------------------------Старше 30 лет\n");
            foreach (Staff item in queue)
            {
        ...
        public static void QueueTask10()
        {
            /*10.   Дан файл, содержащий информацию о студентах: 
                    ...
                    сначала все данные о студентах, успешно обучающихся на 4 и 5, потом 
                    данные об остальных студентах, сохраняя исходный порядок в каждой группе сотрудников.*/
            Queue<Student> queue = new Queue<Student>();
            Random rand = new Random();
            // одним циклом никак
            int[] scores;
